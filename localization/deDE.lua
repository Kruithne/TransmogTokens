...
if GetLocale() == "deDE" then
	...
	L["You need %d appearances from this token."] = "Du benötigst %d Vorlagen von dieser Rüstungsmarke.";
	L["You need one appearance from this token."] = "Du benötigst eine Vorlage von dieser Rüstungsmarke.";
	...
	L["You do not need any appearances from this token."] = "Du benötigst keine Vorlagen von dieser Rüstungsmarke.";
